...
icon: "/images/invictus.svg"
---

I'm developing a new "intergalactic" data browser built with C++23, QML, and Qt6. The system is designed to enable AI-driven interactive messaging for end users. Imagine being aboard a spaceship and requesting a wall-mounted tablet to locate an intruder. The AI would then generate an interactive corridor map, display evacuation routes, and provide real-time tactical guidance—much like a scene from a science fiction film.
